    ...
    <>
      ...
      <section className="mb-12 text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-6">
          Explore our curated collection of professional recipes from verified
          chefs around the world. Find trusted, tested recipes with clear
          instructions and authentic culinary expertise.
        </p>
