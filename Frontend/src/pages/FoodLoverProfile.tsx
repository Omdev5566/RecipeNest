                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-l-2 border-primary pl-4 py-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        "This recipe is amazing! Made it for dinner last
                        night..."
                      </p>
                    </div>
                    ...
                    <div className="border-l-2 border-primary pl-4 py-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        "Perfect dessert for special occasions. Everyone loved
                        it!"
                      </p>
                    </div>
                  </div>
